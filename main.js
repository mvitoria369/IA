    ...
    alternativas: [
      {
        ...
        afirmacao: "Conseguiu utilizar a IA como ferramenta de estudo para simplificar pesquisas."
      },
      {
    ...
    alternativas: [
      {
        ...
        afirmacao: "Vê a IA como uma aliada no mercado de trabalho capaz de criar novas profissões."
      },
      {
    ...
    alternativas: [
      {
        ...
        afirmacao: "Prefere expressar sua criatividade de forma manual e autoral."
      },
      {
    ...
    alternativas: [
      {
        ...
        afirmacao: "Acredita que dominar o uso do chat já é uma contribuição válida por si só."
      },
      {
